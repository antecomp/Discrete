...
\begin{wrapfigure}{r}{0.25\textwidth} %this figure will be at the right
    \centering
    \includegraphics[width=0.25\textwidth]{images/venn/AnB.png}
\end{wrapfigure}
...
\todo[inline]{TODO: something about these wrapfigures is breaking the list indentation, fix it or find an alt way to have this page that doesnt break.}
...
\begin{wrapfigure}{r}{0.25\textwidth} %this figure will be at the right
    \centering
    \includegraphics[width=0.25\textwidth]{images/venn/A-B.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.25\textwidth} %this figure will be at the right
    \centering
    \includegraphics[width=0.25\textwidth]{images/venn/Ap.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.25\textwidth} %this figure will be at the right
    \centering
    \includegraphics[width=0.25\textwidth]{images/venn/A-B B-A.png}
\end{wrapfigure}
...
% and I now realize that LaTeX randomly broke my indentation for itemize elements??????????????????????? Like this is a problem for this entire chapter wtf?
