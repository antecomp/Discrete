...
\bigbreak
\define[An argument is \textbf{valid} if whenever the premises are all true, the conclusion must also be true]
...
%todo: type these out nicely instead of using images.
